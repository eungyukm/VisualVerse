"""
Django settings for vv_core project.
...
SECRET_KEY = "django-insecure-fri#&7gp@tz+3!_ijyw5z9qe-p2#ha00_4vxr+8p*t01nz^8#q"
...
WSGI_APPLICATION = "vv_core.wsgi.application"
...
# settings.py
AUTH_USER_MODEL = 'loginmanager.CustomUser'
